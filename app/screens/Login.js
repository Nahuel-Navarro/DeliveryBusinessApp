...
const Login = () => {
    ...
    return (
        <ScrollView style={{flex:1,backgroundColor:'#fff',flexDirection:'column'}}>
            ...
            {/* login form section */}
            <View style={{flex:2,flexDirection:'column',backgroundColor:'#fff',paddingTop:20,paddingHorizontal:'4%'}} >
                ...
                <View style={{flexDirection:'column',paddingTop:20}} >
                    ...
                    color:'#818181',alignSelf:'flex-end',paddingTop:10}} >Olvidó su contraseña?</Text>
                    </View>

                    <Buttons  btn_text={"Ingresar"} on_press={()=>console.log(formData)} />
                </View>
            </View>
